...
object1.value = 15;	
// This changes the value of the object itself, not just the variable object1
...
Back to the cat lady problem!  What would be the best way to store her emails?  An object like this is a good choice:
...
var doh = “Doh”;
console.log(typeof do.toUpperCase);	// function
console.log(typeof do.toUpperCase());	// string
...
push adds values to an array (it’s the same as append?)
...
“string of characters”.split(x).join(x) always produces the original value
array.split(x).join(x) does not

var myArray = [1, 345, 4564567];
console.log(myArray);				// [1, 345, 4564567]
console.log(myArray.join(" ").split(" "));		// ["1", "345", "4564567"]

var myArray = ["a", "b", "c d"];
console.log(myArray);				// ["a", "b", "c d"]
console.log(myArray.join(" ").split(" "));		// ["a", "b", "c”, “d"]

The charAt method will return the character at a given position:

var paragraph = "born 15-11-2003 (mother Spot): White Fang";
console.log(paragraph.charAt(1));		// “o”
